...
create unique index schedule_time_end_uindex
    on schedule ("time_end");
...
insert into clients (phone, phone_string, telegram_id, user_name, first_name, last_name) values (79857197650, '+7 (901)123-12-12', 123456789, '@Pentrov', 'Петр', 'Петров');
insert into clients (phone, phone_string, telegram_id, user_name, first_name, last_name) values (2, '02', 234567890, '@Ivanov', 'Иван', 'Иванов');
